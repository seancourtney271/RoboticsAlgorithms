...
if("TRUE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/fall/RoboticsAlgorithms/src/lab3)
  set(lab3_DEVEL_PREFIX /home/fall/RoboticsAlgorithms/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/fall/RoboticsAlgorithms/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fall/RoboticsAlgorithms/src/lab3/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lab3_NUM_DUMMY_TARGETS)
      set(lab3_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lab3::wrapped-linker-option${lab3_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lab3_NUM_DUMMY_TARGETS "${lab3_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lab3::wrapped-linker-option${lab3_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lab3_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lab3_dep}_FOUND)
      find_package(${lab3_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lab3_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
